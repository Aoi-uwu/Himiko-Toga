...
module.exports = async (sela, uMsg, msg, embed) => {
   msg.edit('¡Perfecto! ¿Cuál será tu descripción?')
   .then(async msg1 => {
      ...
      c.once('collect', async m => {
         ...
         await msg1.edit('¡Listo! Así quedó el mensaje con el campo **descripción**, ¡sigamos!',
         { embed: embed })
         .then(m => deleteMsg(m, 3500));
         return setTimeout(async () => {
            await uMsg.channel.send('Sigamos con el **color**, ¿deseas agregar uno?')
            .then(async msg2 => {
               await msg2.react('✅');
               await msg2.react('❌');
               ...
               .then(async c2 => {
                  ...
                  if (reaction.emoji.name === '✅') {
                     ...
                     await require('./setColor')(sela, uMsg, msg2, embed);
                     return;
                  }
                  await msg2.reactions.cache.each(r => r.remove());
                  await msg2.edit('Sigamos con la **miniatura**, ¿deseas agregar una?')
                  .then(async msg3 => {
                     await msg3.react('✅');
                     await msg3.react('❌');
                     ...
                     .then(async c3 => {
                        ...
                        if (reaction.emoji.name === '✅') {
                           ...
                           await require('./setThumbnail')(sela, uMsg, msg3, embed);
                           return;
                        }
                        await msg3.reactions.cache.each(r => r.remove());
                        await msg3.edit('Sigamos con el campo **imagen**, ¿deseas agregar una?')
                        .then(async msg4 => {
                           await msg4.react('✅');
                           await msg4.react('❌');
                           ...
                           .then(async c4 => {
                              ...
                              if (reaction.emoji.name === '✅') {
                                 ...
                                 await require('./setImage')(sela, uMsg, msg4, embed);
                                 return;
                              }
                              await msg4.reactions.cache.each(r => r.remove());
                              await msg4.edit('Sigamos con el campo **pie de página**, ¿deseas agregarlo?')
                              .then(async msg5 => {
                                 await msg5.react('✅');
                                 await msg5.react('❌');
                                 ...
                                 .then(async c5 => {
                                    ...
                                    if (reaction.emoji.name === '✅') {
                                       ...
                                       await require('./setFooter')(sela, uMsg, msg5, embed);
                                       return;
                                    }
                                    await msg5.reactions.cache.each(r => r.remove());
