...
module.exports = {
   ...
   run: async (sela, msg, args) => {
      ...
      var embed = new EmbedBuilder()
         .setAuthor({ name: `${msg.author.username}: Bonk`, iconURL: msg.author.displayAvatarURL() })
         ...
         .setFooter({ text: `${member.user.username}: ouch`, iconURL: member.user.displayAvatarURL() })
      msg.channel.send({
         embeds: [embed],
         files: [
            './utility/bonk.mp3'
